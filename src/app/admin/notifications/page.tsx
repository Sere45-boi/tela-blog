    ...
    <div className="max-w-[1200px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <GsapReveal direction="up">
          <h1 className="text-3xl font-bold tracking-tight text-[#1d1d1f] font-bricolage mb-2">Activity Intelligence</h1>
           ...
           <GsapReveal direction="up" delay={0.2}>
              <div className="bg-white/50 backdrop-blur-xl border border-black/5 rounded-2xl p-6 shadow-sm">
                 <h3 className="text-[11px] font-bold text-black/30 uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
                    <Filter className="w-3 h-3" /> Intelligence Filters
                 </h3>
              ...
              <GlassCard className="overflow-hidden shadow-sm flex flex-col min-h-[600px]">
                 {loading ? (
                    <div className="flex-1 flex flex-col items-center justify-center p-20">
                       ...
                       <span className="text-[13px] font-bold text-black/20 uppercase tracking-widest">Synchronizing Intelligence...</span>
                    </div>
                          ...
                          >
                             ...
                             <div className="flex-1">
                                ...
                                <div className="flex items-center gap-4 text-[12px] font-bold text-black/20 uppercase tracking-tight">
                                   ...
                                   <div>System Intelligence Event</div>
                                </div>
                             </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center p-20 text-center">
                       ...
                       <h3 className="text-xl font-bold text-black/20 mb-2 font-bricolage">Intelligence Void</h3>
